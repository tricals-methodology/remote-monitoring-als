...
INPUT_COEFFICIENTS <- c(-0.009341062898525, -0.025470289659360, -0.004235264826105,
...
OUTPUT_COEFFICIENTS <- c(1.00000000000000000000, -3.63367395910957000000, 5.03689812757486000000,
...
bpf_filter <- function (raw_data) {
  ...
  # This is done by firstly defining the filter (a 7th order IIR filter)
